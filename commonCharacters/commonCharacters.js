 ...
 * Write a function that accepts two strings
 as arguments, and returns only the characters
 ...
 * Your function should return the common characters
 ...
 Do not return duplicate characters and ignore whitespace
...
const commonChars = (a, b) => {
  ...
  return common.join('').replace(/\s/g, '');
}

console.log(commonChars('abci iopd', 'cdefiioxp '));
